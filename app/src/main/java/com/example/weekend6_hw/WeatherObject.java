...
public class WeatherObject implements Parcelable
{
    ...
    @Expose
    private Integer cod;
    public final static Parcelable.Creator<WeatherObject> CREATOR = new Creator<WeatherObject>() {
    ...
    protected WeatherObject(Parcel in) {
        ...
        in.readList(this.weather, (com.example.weekend6_hw.Weather.class.getClassLoader()));
     ...
     * @param main
     */
    public WeatherObject(Coord coord, List<Weather> weather, String base, Main main, Integer visibility, Wind wind, Clouds clouds, Integer dt, Sys sys, Integer timezone, Integer id, String name, Integer cod) {
        super();
        this.coord = coord;
